...
bool cInputMgr::isKeyDown(int vkey)
{
	...
	//	return leftMouseBtn=true;            // true if left mouse button down
		//return middleMouseBtn=true;          // true if middle mouse button down
		//return rightMouseBtn=true;           // true if right mouse button down
	}
	else
	{
		return false;
